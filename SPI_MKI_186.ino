...
void recordAccelRegisters(){
  ...
  digitalWrite(CS,LOW);
  SPI.transfer(0x28);
  accelXL=SPI.transfer(0x28);
  digitalWrite(CS,HIGH);
  
  digitalWrite(CS,LOW);
  SPI.transfer(0x29);
  accelXH= SPI.transfer(0x29);
  digitalWrite(CS,HIGH);

  //record acceleration Y
  digitalWrite(CS,LOW);
  SPI.transfer(0x2A);
  accelYL=SPI.transfer(0x2A);
  digitalWrite(CS,HIGH);
